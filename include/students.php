/**
 * FILEPATH: /c:/xampp/htdocs/Next_Gen 2/include/students.php
 * 
 * This file contains the definition of the Student class, which represents a student in the system.
 * The Student class provides methods for interacting with the database table 'tblstudent'.
 * It includes methods for retrieving, creating, updating, and deleting student records.
 * 
 * The Student class also includes methods for authentication and retrieving specific student records.
 * 
 * @package Next_Gen_2
 * @subpackage Include
 */
