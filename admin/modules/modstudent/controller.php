...
function doInsert(){
	if(isset($_POST['studsave'])){
					...
					// }else{
						...
						$student->STUDPASS 		= sha1($_POST['StudentID']);
						// $student->PROIMAGE 		= $location;
						$student->create(); 
 
						$parent = New Parents();
						$parent->StudentID 			= $_POST['StudentID'];
						$parent->create(); 


						$schoolyear = New Schoolyear();
						$schoolyear->StudentID 			= $_POST['StudentID'];
						...
						// $work = New Work();
						// $work->StudentID 			= $_POST['StudentID'];
						// $work->create();
...
// 	$student->update($_POST['MStudentID']);
// 	redirect("index.php?view=view&id=".$_POST['MStudentID']."&sy=".$_POST['SYID']);
